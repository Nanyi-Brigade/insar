...
for obj in object_list:
    ...
    VX_LOC.append(float(vx))
    VY_LOC.append(float(vy))
    VZ_LOC.append(float(vz))
    UTC.append(utc)
...
vx_parameters = Solu_parameters(VX_LOC , UTC_TIME)
vy_parameters = Solu_parameters(VY_LOC , UTC_TIME)
vz_parameters = Solu_parameters(VZ_LOC , UTC_TIME)
#print(vz_parameters)